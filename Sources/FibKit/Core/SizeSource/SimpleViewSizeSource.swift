...
open class SimpleViewSizeSource: SizeSource<UIView>, CollectionReloadable {
    ...
    open override func size(at index: Int, data: UIView, collectionSize: CGSize) -> CGSize {
        ...
        let fitSize = mainOrSync {
			data.sizeThatFits(collectionSize)
		}
        ...
        case .offset(let value): width = collectionSize.width - value
        }
        ...
        case .offset(let value): height = collectionSize.height - value
        }
